...
const HeroSectionProjects = () => {
 ...
 const handleDeletion = async (projectId) => {
  ...
  return (
    <div
      className={`pt-24 pb-12 transition-colors duration-300 min-h-screen ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          <div>
            ...
            >
              Managing {projects.length} Webhook end-points across your
              workspace.
            </p>
          </div>
            ...
            {filteredProjects.map((project) => (
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  ...
                  <div
                    className="relative"
                    ref={openMenuId === project._id ? menuRef : null}
                  >
                    <button
                    ...
                    {openMenuId === project._id && (
                      <div
                        className={`absolute right-0 mt-2 w-48 rounded-2xl border shadow-2xl z-20 py-2 overflow-hidden animate-in fade-in zoom-in duration-200 ${
                          isDarkMode
